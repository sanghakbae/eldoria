...
const translations = {
  en: {
    ...
    untamedWilds: "The Untamed Wilds", animalDen: "Wild Animal Den", greythorn: "Greythorn Wood", amberfen: "Amberfen Wilds", hollowVault: "The Hollow Vault", sunscar: "Sunscar Desert", emeraldJungle: "Emerald Jungle", wildZone: "Frontier zone",
  ...
  ko: {
    ...
    untamedWilds: "태초의 황야", animalDen: "야생 동물 굴", greythorn: "그레이쏜 숲", amberfen: "앰버펜 황야", hollowVault: "공허의 금고", sunscar: "태양흉터 사막", emeraldJungle: "비취 밀림", wildZone: "변경 지역",
