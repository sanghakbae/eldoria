...
const translations = {
  en: {
    ...
    activeSkills: "ACTIVE SKILLS", swordsmanship: "Swordsmanship", unarmed: "Unarmed", butchering: "Butchering", lumberjacking: "Lumberjacking", worldAria: "Eldoria game world",
    ...
    greythorn: "Greythorn Wood", amberfen: "Amberfen Wilds", hollowVault: "The Hollow Vault", wildZone: "Frontier zone",
  ...
  ko: {
    ...
    activeSkills: "활성 기술", swordsmanship: "검술", unarmed: "맨손 격투", butchering: "도축", lumberjacking: "벌목", worldAria: "엘도리아 게임 월드",
    mossward: "모스워드 교차로", safeSettlement: "안전 정착지", roadHint: "동쪽 길은 그레이쏜 숲으로 이어집니다", journal: "여행 일지",
    greythorn: "그레이쏜 숲", amberfen: "앰버펜 황야", hollowVault: "공허의 금고", wildZone: "변경 지역",
